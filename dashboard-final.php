...
<html lang="en">
    ...
    <body>
        <div class="container">
            <?php include('partials/sidebar-final.php');?>
            <!-- FINAL ASIDE -->
            <main>
                <h1>Menú</h1>
                ...
                <div class="showing">
                    <div class="input-sale">
                        ...
                        <small class="text-muted"><?php $fecha = date_default_timezone_set('America/Lima'); 
                        $fecha = date('Y-m-d');
                        echo $fecha?></small>
                    </div>
                ...
                <div class="recent-sales">
                    ...
                    <a href="mostrar-ventas-final.php">Mostrar todos</a>
                </div>
            </main>
            <!-- FINAL MAIN-->
