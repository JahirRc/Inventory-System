...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <form name="reporte" action="reporte.php" method="POST" id="stripe-login">
            <div class="date">
                ...
                <div class="date">
                    <button id="reporte" style="background:none";>
                        <span style="color: var(--color-dark)";>Reporte diario</span>
                    </button>  
                </div>
            </form>
