                ...
                <form action="registrar-producto-final.php" method="POST" id="stripe-login">
                    <section class="login">
                        <div class="wrapper">
                            ...
                            <label class="login__label">
                                <span>Precio</span>
                                <input type="text" class="input" name="precio" id="precio" autocomplete="off" 
                                value="<?php echo $precio;?>">
                            </label>
                            
                            <label class="login__label">
                                <span>Precio Público</span>
                                <input type="text" class="input" name="precio_pub" id="precio_pub" autocomplete="off" 
                                value="<?php echo $precio_pub;?>">
                            </label>
                            
                            <label class="login__label">
                                <span>Precio Oferta</span>
                                <input type="text" class="input" name="precio_o" id="precio_o" autocomplete="off" 
                                value="<?php echo $precio_o;?>">
                            </label>
                            
                            <label class="login__label">
                                <span>Precio por Mayor</span>
                                <input type="text" class="input" name="precio_m" id="precio_m" autocomplete="off" 
                                value="<?php echo $precio_m;?>">
                            </label>
                            
                            <div class="login__label">
                                <span>Stock</span>
                                <input type="number" class="input" name="stock" id="stock" 
